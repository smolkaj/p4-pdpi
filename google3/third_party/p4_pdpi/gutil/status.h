...
// // RETURN_IF_ERROR evaluates an expression that returns a absl::Status. If
// the
...
//
// // These macros help create unique variable names for ASSIGN_OR_RETURN. Not
// for
// // public use.
...
//
// // An implementation of ASSIGN_OR_RETURN that does not include a
// StatusBuilder.
// // Not for public use.
...
//
// // An implementation of ASSIGN_OR_RETURN that provides a StatusBuilder for
// extra
...
// // result is ok, the value is saved to dest. Otherwise, the status is
// returned.
// //
// // Example:
...
// // absl::StatusBuilder commands. Usage should assume a StatusBuilder object
// is
